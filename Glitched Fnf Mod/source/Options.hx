...
class GhostTapOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.ghost ? "Noob Input" : "Compota Input";
	}
}
...
class SevenKeyMenu extends Option
{
	private var controls:Controls;
	...
	public override function press():Bool
	{
		OptionsMenu.instance.openSubState(new SevenKeyBindMenu());
		return false;
	}

	private override function updateDisplay():String
	{
		return "Key Bindings for Seven Key"; //Cool DUDE 
	}
}
