...
// Code Recreated By HopesRei taken Shaggy Mod 
...
class SevenKeyBindMenu extends FlxSubState
{

    var keyTextDisplay:FlxText;
    var keyWarning:FlxText;
    var warningTween:FlxTween;
    var keyText:Array<String> = ["LEFT1", "UP", "RIGHT1", "MIDDLE", "LEFT2", "DOWN", "RIGHT2"];
    var defaultKeys:Array<String> = ["S", "D", "F", "J", "SPACE", "K", "L"];
    var defaultArrowKeys:Array<String> = ["S", "D", "F", "SPACE","LEFT", "DOWN", "RIGHT"];
